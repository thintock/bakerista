...
<div class="container">
     <div class="flex justify-between items-center mb-4">
        ...
        <h1 class="text-2xl font-semibold">新規お客様対応登録</h1>
        <div></div>
    </div>
    <div class="w-full mx-auto ">
        <form action="{{ route('customerRelations.store') }}" id="uploadForm" method="POST" class="lg:flex lg:gap-10" enctype="multipart/form-data">
            @csrf
             <!-- 左側のセクション -->
            <div class="lg:w-2/5">
                        ...
                        <div class="card border mt-4">
                            <div class="card-body p-3">
                                <div class="flex justify-between items-center mb-2">
                                    ...
                                    <div>
                                        対応者：{{ Auth::user()->name }} {{ Auth::user()->first_name }}
                                    </div>
                                </div>
                                <div class="form-control">
