    ...
    <div class="overflow-x-auto">
        ...
        <!-- head -->
            ...
            <tbody>
              ...
              <tr>
                <td><p>{{ $millPurchaseMaterial->id }}</p></td>
                <td><p>{{ $millPurchaseMaterial->lot_number }}</p></td>
                <td>
                    <div class="badge badge-secondary badge-outline">{{ $millPurchaseMaterial->material->materials_producer_name }}</div>
                    <h2>{{ $millPurchaseMaterial->material->materials_code }}&nbsp;{{ $millPurchaseMaterial->material->materials_name }}</h2>
                </td>
                <td><p>{{ $millPurchaseMaterial->year_of_production }}年度</p></td>
                <td><p>{{ $millPurchaseMaterial->flecon_number }}</p></td>
                ...
                <td><p>{{ $millPurchaseMaterial->user->name }}&nbsp;{{ $millPurchaseMaterial->user->first_name }}</p></td>
                <td><p>{{ $millPurchaseMaterial->created_at->format('Y年m月d日 H時i分') }}</p></td>
                <td><p>{{ $millPurchaseMaterial->updated_at->format('Y年m月d日 H時i分') }}</p></td>
