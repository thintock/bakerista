        ...
        <form action="{{ route('millPurchaseMaterials.update', $millPurchaseMaterial->id) }}" class="mb-4" method="POST">
            ...
            <div class="form-control">
                <label class="label" for="materials_id">
                    <span class="label-text">原材料<span class="text-accent">（変更不可）</span></span>
                </label>
            ...
            <div class="form-control">
                <label class="label" for="flecon_number">
                    <span class="label-text">フレコン番号<span class="text-accent">（変更不可）</span></span>
                </label>
            ...
            <div class="form-control">
                <label class="label" for="lot_number">
                    <span class="label-text">ロットナンバー<span class="text-accent">（変更不可）</span></span>
                </label>
