...
<div class="container mx-auto p-6">
    <h1 class="text-2xl font-bold mb-4">精麦済み原料の編集</h1>
        <form action="{{ route('millPolishedMaterials.update', $polishedMaterial->id) }}" method="POST" id="editForm">
            ...
            <div class="flex mt-6">
                <button type="submit" class="btn btn-primary w-1/2 mr-3">更新</button>
            </form>
        <!-- 削除ボタン -->
